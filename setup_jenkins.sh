...
echo "${GITHUB_SSH_PRIVATE_KEY}" > /var/lib/jenkins/github_ssh_key
echo "${DOCKER_USERNAME}" > /var/lib/jenkins/dockerUsername
echo "${DOCKER_PASSWORD}" > /var/lib/jenkins/dockerPassword
